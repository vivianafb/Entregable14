...
class Productos{
    ...
    listarIndividual(productos:any,id:any){
        return productos.find((aProduct:any) => aProduct.id == id);  
    }

    almacenar(nombre:any,precio:any,foto:any){
        const nuevoProducto = {
    ...
    actualizar(id:any,nombre:any,precio:any){
...
router.get('/vista', (req:any, res:any) => {
...
router.get('/listar', (req:any, res:any) => {
  let array = new Productos();
  let lista = array.listar(productos);
  if (!lista) {
      res.status = 404;
...
router.post('/guardar', (req:any, res:any) => {
    let array = new Productos();
...
router.put('/actualizar/:id', (req:any, res:any) => { 
...
router.delete('/borrar/:id', (req:any, res:any) => {
